    ...
    if (enableReminder) {
      if (reminderType === 'date' && reminderDate) {
        addReminder(id, {
          ...
          logType: 'Insurance Renewal',
          logId: newLog.id,
          description: `Renew insurance with ${formValues.provider}`,
          category: 'insurance',
        });
          ...
          <form className="grid gap-4 md:grid-cols-2" onSubmit={handleAddLog}>
            ...
            <div className="md:col-span-2 border-t border-gray-700 pt-4 mt-4 space-y-4">
              ...
              <p className="text-sm text-slate-400 mb-2">
                Get notified when it's time to renew your insurance. Choose date-based or odometer-based reminders.
              </p>
              <label className="flex items-center gap-3 cursor-pointer p-3 bg-gray-900/50 rounded-md hover:bg-gray-900/70 transition-colors">
                ...
                />
                <span className="text-slate-200 font-semibold">Set Reminder for Renewal</span>
              </label>
                  ...
                  {reminderType === 'date' && (
                    <label className="flex flex-col text-slate-200">
                      ...
                      <input
                        ...
                        min={formValues.endDate || new Date().toISOString().split('T')[0]}
                      ...
                      <p className="text-xs text-slate-500 mt-1">
                        Recommended: Set before policy end date ({formValues.endDate || 'N/A'})
                      </p>
                    </label>
                  )}
